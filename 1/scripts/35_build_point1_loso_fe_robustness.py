...
def load_clean_assoc() -> pd.DataFrame:
    assoc = harmonize_assoc_columns(pd.read_csv(TAB / "point1_native_only_endpoint_exwas_associations.csv", low_memory=False))
    ...
    assoc = assoc[
        ...
        & assoc["phenotype_scope"].isin(["total_same_50", "per_cow_50"])
