...
US_EXPOSE_NEW = STAT.parents[2] / "data" / "us_expose_new" / "processed"
OUT_ROWS = TAB / "point1_chord_signal_yearly_variable_associations.csv"
OUT_SUMMARY = TAB / "point1_chord_signal_yearly_class_summary.csv"
OUT_AUDIT = TAB / "point1_chord_signal_yearly_class_method_audit.csv"
...
def load_panel() -> pd.DataFrame:
    panel = L.load_panel()
    # Same-50 total-production endpoint paired with the per-cow endpoint is
    # populated with the same monthly-equivalent 50-state production values.
