...
scope_levels <- c("total_same_50", "per_cow_50")
scope_labels <- c(
...
p <- ggplot(d_plot, aes(neglogp, y_order)) +
  ...
  labs(
    ...
    subtitle = paste0("Clean ", n_exposures, "-variable pool; classes are ordered and coloured by domain. Event and slow-context classes use their preferred statistics."),
