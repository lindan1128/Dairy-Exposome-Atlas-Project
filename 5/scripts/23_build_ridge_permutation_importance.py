...
def main() -> int:
    ...
    out['significant_importance'] = np.where((out['fdr_p_value'] < 0.05) & (out['permutation_importance_rmse'] > 0), out['permutation_importance_rmse'], 0.0)
    out = out.merge(meta, on='feature', how='left')
    out.to_csv(TAB5 / 'point5_exposome_milk_loss_risk_region_node_permutation_importance_long.csv', index=False)
    ...
    summary.to_csv(TAB5 / 'point5_exposome_milk_loss_risk_region_node_permutation_importance_summary.csv', index=False)
    ...
    union.to_csv(TAB5 / 'point5_exposome_milk_loss_risk_region_node_permutation_fdr_union.csv', index=False)
    print('Wrote permutation importance tables')
